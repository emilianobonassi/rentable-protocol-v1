...
def test_wrappers_proxy_init(TestNFT, ERC721ReadOnlyProxyInitializable, proxyFactoryInitializable, deployer, accounts):
    ...
    wrapperProxy = ERC721ReadOnlyProxyInitializable.at((tx.events["ProxyCreated"]["proxy"]), owner)
...
def test_wrappers_proxy_double_init(TestNFT, ERC721ReadOnlyProxyInitializable, proxyFactoryInitializable, deployer, accounts):
