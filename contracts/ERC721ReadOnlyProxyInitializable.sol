...
contract ERC721ReadOnlyProxyInitializable is ERC721ReadOnlyProxy {
    constructor(address wrapped, string memory prefix) ERC721ReadOnlyProxy (wrapped, prefix) {}

    function init(address wrapped, string memory prefix, address owner) external virtual {
